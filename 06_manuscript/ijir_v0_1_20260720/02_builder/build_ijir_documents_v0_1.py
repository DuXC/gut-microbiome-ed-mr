...
main_md = (SRC / "IJIR_Main_Manuscript_v0_1.md").read_text()
title_md = (SRC / "IJIR_Title_Page_v0_1.md").read_text()
cover_md = (SRC / "IJIR_Cover_Letter_v0_1.md").read_text()
...
doc.save(OUT / "IJIR_Main_Manuscript_v0_1.docx")

doc = Document(); setup(doc, double=True, line_numbers=True)
add_markdown(doc, title_md)
doc.save(OUT / "IJIR_Title_Page_v0_1.docx")

doc = Document(); setup(doc, double=False, line_numbers=False)
add_markdown(doc, cover_md)
doc.save(OUT / "IJIR_Cover_Letter_v0_1.docx")
...
checklist = [
 ...
 ("9", "Statistical methods", "Methods: MR estimation, sensitivity analyses, and multiplicity", "Wald ratio, IVW, robust estimators, directionality, pleiotropy and multiplicity prespecified."),
 ...
 ("11", "Sensitivity analyses", "Methods; Results", "HUNT validation, known-overlap ED sensitivity, robust methods and failure handling reported."),
 ...
 ("13", "Main results", "Results: Forward and reverse analyses; Figure 2; Table 2", "Effect estimates, P values, FDR results and expected nominal counts reported."),
 ("14", "Additional analyses", "Results; Supplementary Data", "Replication results, instrument inventory and method-status records supplied."),
 ("15", "Key results", "Discussion, paragraph 1", "Results interpreted against objectives without promoting nominal findings."),
 ("16", "Limitations", "Discussion, paragraphs 3–4", "Sparse instruments, pleiotropy, matching, phenotype, overlap and ancestry limitations described."),
...
doc.save(OUT / "IJIR_STROBE_MR_Checklist_v0_1.docx")
